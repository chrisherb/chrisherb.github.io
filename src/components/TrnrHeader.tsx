...
export function TrnrHeader() {
    return (
        <Header background={'control'} pad={{ left: 'small', top: 'small', right: 'xlarge', bottom: 'small' }} sticky='scrollup'>
            <Anchor href='#top'><Image width={55} src='/trnr-logo-sqr.svg' /></Anchor>
