...
export function TrnrFooter() {
  ...
  return (
    ...
    >
      ...
      {showTerms && (
        <Layer
          onEsc={() => setShowTerms(false)}
          onClickOutside={() => setShowTerms(false)}
          position="center"
        >
          <Box pad="medium" background="light-1" overflow="auto" width="large">
            ...
            <Text>
              ...
              dem Zeitpunkt der Kenntniserlangung einer konkreten
            ...
            <Text>
              ...
              Betreiber (Urheber) der Seiten verantwortlich. Die externen Links
              wurden zum Zeitpunkt der Linksetzung auf eventuelle Rechtsverstöße
              überprüft und waren im Zeitpunkt der Linksetzung frei von
              rechtswidrigen Inhalten. Eine ständige inhaltliche Überprüfung der
              externen Links ist ohne konkrete Anhaltspunkte einer
              Rechtsverletzung nicht möglich. Bei direkten oder indirekten
              Verlinkungen auf die Webseiten Dritter, die außerhalb unseres
              ...
              Kenntnis erlangen und es uns technisch möglich und zumutbar wäre,
            ...
            <Text>
              ...
              Internetauftrittes www.ternär.tech gesetzten Links und Verweise
              von Fragestellern, Blogeinträgern, Gästen des Diskussionsforums.
              ...
              der Diensteanbieter der Seite, auf welche verwiesen wurde, nicht
              derjenige, der über Links auf die jeweilige Veröffentlichung
              lediglich verweist. Werden uns Rechtsverletzungen bekannt, werden
            ...
            <Text>
              ...
              <Anchor href="http://www.gesetze-im-internet.de/bundesrecht/urhg/gesamt.pdf">
                http://www.gesetze-im-internet.de/bundesrecht/urhg/gesamt.pdf
              </Anchor>
              ) . Die Vervielfältigung, Bearbeitung, Verbreitung und jede Art
              der Verwertung des geistigen Eigentums in ideeller und materieller
            ...
            <Text>
              Dieses{" "}
              <Anchor href="http://www.jurarat.de/muster-impressum">
                Impressum
              </Anchor>{" "}
