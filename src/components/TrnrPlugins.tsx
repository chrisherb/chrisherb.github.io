import { Box, Image, Text, List, Heading, Anchor, Grid, Button, ResponsiveContext } from "grommet";
...
export function TrnrPlugins() {
    return (
        <ResponsiveContext.Consumer>
            {size =>
                <Box id='plugins' pad={{ left: 'xlarge', top: 'medium', right: 'xlarge', bottom: 'xlarge' }} background={{ opacity: 'medium', image: 'url(/triplex-monitor.jpg)' }}>
                    <Box direction="row" justify='between' pad={{ top: 'medium', bottom: 'medium' }} margin={{ bottom: 'large' }} border='bottom'>
                        <Heading level='3' size='xlarge' margin='0'>Plugins</Heading>
                        <Anchor icon={<Link />} href='#plugins' />
                    </Box>
                    <Grid gap='small' columns={{ count: (size === 'large' ? 3 : size === 'medium' ? 2 : 1), size: 'auto' }}>
                        <Box direction='column' gap='medium'>
                            <Heading level='4' size='xlarge' margin={{ top: 'none', bottom: 'xsmall' }}>Triplex Classic (Early Access)</Heading>
                            <Text>
                            ...
                            <Box direction='row-responsive' gap='medium'>
                                <Windows />
                                <Apple />
                                <Button label='Download Demo' href='https://trnr.gumroad.com/l/triplex-classic-demo' />
                                <Button primary label='Buy Full Version' href='https://trnr.gumroad.com/l/triplex-classic' />
                            </Box>
                        </Box>
                        <Box>
                            <Box
                                ...
                                <Anchor href='https://trnr.gumroad.com/l/triplex-classic'>
                                    <Image src='/triplex-screenshot.png' fill='horizontal' alt="Triplex Classic Screenshot" />
                                </Anchor>
                            </Box>
                        </Box>
                        <Box direction='column'>
                            <Heading level='4' size='xlarge' margin={{ top: 'none', bottom: 'medium' }}>
                                Features:
                            </Heading>
                            <List data={[
                                ...
                                primaryKey={(datum) => (<Box gap='medium' direction='row'><Diamond size='medium' /><Text>{datum}</Text></Box>)}>
                            </List>
                        </Box>
                    </Grid>
