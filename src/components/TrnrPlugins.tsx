          ...
          >
            <Box direction="column" gap="medium">
              ...
              <Text>
                ...
                them in an easy-to-use, accessible interface. The synth engine
                was developed from the ground up to facilitate sounds ranging
                from pristine modern FM sounds to crunchy bit-crushed mayhem -
              ...
              <Text>
                ...
                the AU and AAX versions. Controlling parameters via MIDI is also
